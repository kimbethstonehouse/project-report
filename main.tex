...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{figures/cores-lapics.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{figures/state-flowchart.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{figures/init-sipi-sipi.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.6]{figures/schedulers.pdf}
