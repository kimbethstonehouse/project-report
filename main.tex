...
\abstract{
Multicore architectures are pervasive within the computing industry and students must have a good understanding of the related theoretical concepts. However, prominent open-source operating systems such as Linux are extremely complex to understand. Furthermore, the monolithic nature of such operating system schedulers make experimenting and researching new scheduling approaches almost impossible. This project solves that problem by adding multicore processing support to a research operating system, InfOS. By redesigning InfOS specifically with multicore processing in mind, we produce a well-structured, clean codebase that can be used as a valuable teaching tool to help undergraduate students grasp multicore concepts. Furthermore, we produce a research platform for investigating intelligent scheduling approaches, and provide suggestions for a future research paper on cache-aware scheduling.
}
...
To my incredible friends Jen and George, who have provided unwavering support throughout some very challenging times. It most certainly would not have been possible without you.

To my truly remarkable flatmates, Sarah and Orlagh, for their constant positivity, enthusiasm and being an endless source of laughter.

Lastly, to my wonderful family for their support during my time at university and their encouragement to continue to postgraduate study.
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.28]{figures/linux-loc.png}
